...
const EditBlog = () => {
  ...
  const editBlog = async (e)=>{
    e.preventDefault()
    const response = await axios.put("https://64ee09461f87218271423715.mockapi.io/Blogs/" + id,blog)
  ...
  const fetchBlog = async ()=>{
    const response = await axios.get("https://64ee09461f87218271423715.mockapi.io/Blogs/" + id)
    if(response.status == 200){
